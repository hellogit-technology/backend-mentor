...
router.route('/event')
    ...
    .patch(eventsControllers.updateEvent)
...
// Club
router.route('/club')
    .post(clubsControllers.createClub)
    .patch(clubsControllers.updateClub)
    .delete(clubsControllers.deleteClub)

// Leader Account
router.post('/leader-account', leaderAccountControllers.createLeader)
router.route('/leader-account/:id')
    .patch(leaderAccountControllers.updateLeader)
    .delete(leaderAccountControllers.deleteLeader)

// Admin Account
router.post('/admin-account', adminAccountControllers.createAdmin)
router.route('/admin-account/:id')
    .patch(adminAccountControllers.updateAdmin)
    .delete(adminAccountControllers.deleteAdmin)
